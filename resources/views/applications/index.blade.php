                ...
                <div class="p-2 text-gray-900 dark:text-gray-100">
                    ...
                    <div class='mt-5 p-6 text-gray-900 dark:text-gray-100'>
                        @foreach ($applications as $application)
                            <div style="margin-left: 100px" class="rounded-xl border p-5 mt-5 shadow-md w-9/12 bg-white">
                                ...
                                <div class="mt-3">
                                    <div>
                                        ...
                                        @else
                                            <br><br>
                                            <div
                                                class="text-neutral-600 border rounded hover:bg-gray-50 transition cursor-pointer flex flex-col items-right">
                                                <hr>
                                                <h3>Answer : </h3>
